...
ALTER TABLE IF EXISTS ONLY public.schedules DROP CONSTRAINT IF EXISTS schedules_filmid_fkey;
...
92b8a2a7-ab6b-4fa9-915b-d27945865e39	8.1	Амелия Хьюз	Рекомендуемые	/bg6s.jpg	/bg6c.jpg	Сон в летний день	Фэнтези-фильм о группе друзей попавших в волшебный лес.	Причудливый фэнтези-фильм о волшебном лесу.
0354a762-8928-427f-81d7-1656f717f39c	9.5	Оливер Беннет	Рекомендуемые	/bg4s.jpg	/bg4c.jpg	Парадокс Нексуса	Эксперимент по соединению человеческих умов.	Фильм о границах сознания.
5b70cb1a-61c9-47b1-b207-31f9e89087ff	8.9	Лила Васкес	Рекомендуемые	/bg2s.jpg	/bg2c.jpg	Стражи Гримуара	Фэнтезийное приключение.	История о защите древнего тома.
3bedbc5a-844b-40eb-9d77-83b104e0cf75	8.5	Элиза Уиттакер	Рекомендуемые	/bg5s.jpg	/bg5c.jpg	Звёздное путешествие	Научная фантастика.	Путешествие по галактике.
51b4bc85-646d-47fc-b988-3e7051a9fe9e	9	Харрисон Рид	Рекомендуемые	/bg3s.jpg	/bg3c.jpg	Недостижимая утопия	Антиутопия.	История о системе и свободе.
0e33c7f6-27a7-4aa0-8e61-65d7e5effecf	2.9	Итан Райт	Документальный	/bg1s.jpg	/bg1c.jpg	Архитекторы общества	Документальный фильм.	Фильм о технологиях и ИИ.
\.
...
--
-- Name: schedules schedules_filmid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.schedules
    ADD CONSTRAINT schedules_filmid_fkey FOREIGN KEY ("filmId") REFERENCES public.films(id);
